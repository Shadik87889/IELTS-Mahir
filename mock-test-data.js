...
export const listeningQuestions = [
  ...
  // --- New Questions for Test 2 ---

  // Part 1: Questions 1-8 (Fill in the blank) - from Screenshot 2025-07-08 154824.png
  {
    id: "L41",
    type: "fill-in-the-blank",
    audioPrompt:
      "Section 1: Questions 1-8. You will hear a conversation about Denham's Shipping Agency. Complete the form below.",
    questionText:
      "1. Customer quotation form: Name: Tim 1. Address to be collected from: 2 __________ University.",
    correctAnswer: "", // Placeholder
  },
  {
    id: "L42",
    type: "fill-in-the-blank",
    audioPrompt: "Complete the form.",
    questionText: "2. Town: Brighton. Postcode: 3 __________.",
    correctAnswer: "", // Placeholder
  },
  {
    id: "L43",
    type: "fill-in-the-blank",
    audioPrompt: "Complete the form.",
    questionText: "3. Size of container: Length: 2.5m, Width: 4 __________.",
    correctAnswer: "", // Placeholder
  },
  {
    id: "L44",
    type: "fill-in-the-blank",
    audioPrompt: "Complete the form.",
    questionText: "4. Size of container: Depth: 5 __________.",
    correctAnswer: "", // Placeholder
  },
  {
    id: "L45",
    type: "fill-in-the-blank",
    audioPrompt: "Complete the form.",
    questionText: "5. Contents: books, 6 __________.",
    correctAnswer: "", // Placeholder
  },
  {
    id: "L46",
    type: "fill-in-the-blank",
    audioPrompt: "Complete the form.",
    questionText: "6. Contents: books, 7 __________.",
    correctAnswer: "", // Placeholder
  },
  {
    id: "L47",
    type: "fill-in-the-blank",
    audioPrompt: "Complete the form.",
    questionText: "7. Total estimated value: £ 8 __________.",
    correctAnswer: "", // Placeholder
  },
  {
    id: "L48",
    type: "fill-in-the-blank",
    audioPrompt: "Complete the form.",
    questionText: "8. Total estimated value: £ __________.",
    correctAnswer: "", // Placeholder
  },
  // Part 1: Questions 9-10 (Multiple Choice) - from Screenshot 2025-07-08 154824.png
  {
    id: "L49",
    type: "multiple-choice",
    audioPrompt: "Questions 9-10. Choose the correct letter, A, B or C.",
    questionText: "9. What is the minimum recommended cover by delivered?",
  ...
  },
  {
    id: "L50",
    type: "multiple-choice",
    audioPrompt: "Choose the correct letter, A, B or C.",
    questionText: "10. Where does the customer want the goods the agency?",
    options: ["A. Port", "B. Home", "C. Business"],
    correctAnswer: "", // Placeholder
  },

  // Part 2: Questions 11-15 (Map Labeling/Fill in the blank) - from Screenshot 2025-07-08 154833.png
  {
    id: "L51",
    type: "fill-in-the-blank", // This will require specific rendering for map labeling
    audioPrompt: "Section 2: Questions 11-15. Label the plan below.",
    questionText: "11. Entrance", // Placeholder for map label
    correctAnswer: "", // Placeholder
  },
  {
    id: "L52",
    type: "fill-in-the-blank", // This will require specific rendering for map labeling
    audioPrompt: "Label the plan below.",
    questionText: "12. __________", // Placeholder for map label
    correctAnswer: "", // Placeholder
  },
  {
    id: "L53",
    type: "fill-in-the-blank", // This will require specific rendering for map labeling
    audioPrompt: "Label the plan below.",
    questionText: "13. __________", // Placeholder for map label
    correctAnswer: "", // Placeholder
  },
  {
    id: "L54",
    type: "fill-in-the-blank", // This will require specific rendering for map labeling
    audioPrompt: "Label the plan below.",
    questionText: "14. __________", // Placeholder for map label
    correctAnswer: "", // Placeholder
  },
  {
    id: "L55",
    type: "fill-in-the-blank", // This will require specific rendering for map labeling
    audioPrompt: "15. __________", // Placeholder for map label
    correctAnswer: "", // Placeholder
  },

  // Part 2: Questions 16-20 (Matching) - from Screenshot 2025-07-08 154833.png
  {
    id: "L56-60",
    type: "matching",
    audioPrompt:
      "Questions 16-20. What does the tour guide tell her tour group about each of the following places on the day's itinerary? Write the correct letter, A, B or C next to questions 16-20 below.",
    questionText: "Match the statements (A-C) to the places (16-20):",
    items: [
      { key: "16. The Aquarium", value: "" },
      { key: "17. Solicia Country Club", value: "" },
      { key: "18. Milltown Winery", value: "" },
      { key: "19. The Zoological Gardens", value: "" },
      { key: "20. The Stout Brewery", value: "" },
    ],
    options: [
  ...
  // Part 3: Questions 21-25 (Fill in the blank) - from Screenshot 2025-07-08 154833.png
  {
    id: "L61",
    type: "fill-in-the-blank",
    audioPrompt:
      "Section 3: Questions 21-25. Complete the sentences below. Write NO MORE THAN TWO WORDS for each answer.",
    questionText:
      "21. Gyroscopes are used in laser devices and are found in many consumer __________.",
    correctAnswer: "", // Placeholder
  },
  {
    id: "L62",
    type: "fill-in-the-blank",
    audioPrompt: "Complete the sentences.",
    questionText:
      "22. The purpose of the project is to design a functional __________ product.",
    correctAnswer: "", // Placeholder
  },
  {
    id: "L63",
    ...
    audioPrompt: "Complete the sentences.",
    questionText:
      "23. The gyroscopic exercise ball can be set in motion by movements of the __________ and wrist together in synch.",
    correctAnswer: "", // Placeholder
  },
  {
    id: "L64",
    ...
    audioPrompt: "Complete the sentences.",
    questionText:
      "24. The gyroscopic ball could help people in __________ who have lower-arm injuries.",
    correctAnswer: "", // Placeholder
  },
  {
    id: "L65",
    ...
    audioPrompt: "Complete the sentences.",
    questionText:
      "25. The product could also be aimed at __________ for whom lower-arm strength is very important.",
    correctAnswer: "", // Placeholder
  },

  // Part 3: Questions 26-30 (Table Completion/Fill in the blank) - from Screenshot 2025-07-08 154833.png
  {
    id: "L66-70",
    type: "table-completion",
    audioPrompt:
      "Questions 26-30. Complete the table below. Write NO MORE THAN THREE WORDS AND/OR A NUMBER for each answer.",
    questionText: "Complete the table:",
    table: {
      headers: ["", "Prototype Design", "Testing"],
      rows: [
        ["Estimated Cost", "£ 3,000", "£ 26."],
        ["Number of Weeks", "27. __________", "28. __________"],
        [
          "Number of Test Subjects",
          "29. __________",
          "5 professional athletes",
        ],
        ["Breakdown of Test Subjects", "30. __________", ""],
      ],
    },
    correctAnswers: {
      "27": "", // Placeholder
  ...
  // Part 4: Questions 31-35 (Multiple Choice) - from Screenshot 2025-07-08 154840.png
  {
    id: "L71",
    type: "multiple-choice",
    audioPrompt:
      "Part 4: Questions 31-35. Choose the correct letter, A, B or C.",
    questionText: "31. Speakers have to know",
    options: [
      "A. Their material.",
      "B. Their audience.",
      "C. Their limitations.",
  ...
  },
  {
    ...
    type: "multiple-choice",
    audioPrompt: "Choose the correct letter, A, B or C.",
    questionText: "32. Experienced speakers",
    options: [
  ...
  },
  {
    ...
    type: "multiple-choice",
    audioPrompt: "Choose the correct letter, A, B or C.",
    questionText: "33. You should always rehearse",
    options: [
  ...
  },
  {
    ...
    type: "multiple-choice",
    audioPrompt: "Choose the correct letter, A, B or C.",
    questionText: "34. It is a good idea to",
    options: [
  ...
  },
  {
    ...
    type: "multiple-choice",
    audioPrompt: "Choose the correct letter, A, B or C.",
    questionText: "35. Taking a few deep breaths before you begin",
    options: [
  ...
  // Part 4: Questions 36-40 (Fill in the blank) - from Screenshot 2025-07-08 154840.png
  {
    id: "L76",
    type: "fill-in-the-blank",
    audioPrompt:
      "Questions 36-40. Complete the sentences below. Write NO MORE THAN TWO WORDS AND/OR A NUMBER for each answer.",
    questionText:
      "36. Useful Tips for a Successful Presentation: Try to __________ yourself making a speech and imagine your voice loud and confident.",
    correctAnswer: "", // Placeholder
  },
  {
    id: "L77",
    type: "fill-in-the-blank",
    audioPrompt: "Complete the sentences.",
    questionText: "37. Even if you make mistakes avoid making __________.",
    correctAnswer: "", // Placeholder
  },
  {
    id: "L78",
    ...
    audioPrompt: "Complete the sentences.",
    questionText:
      "38. Pay attention to your __________ - your words carry less meaning than your delivery.",
    correctAnswer: "", // Placeholder
  },
  {
    id: "L79",
    ...
    audioPrompt: "Complete the sentences.",
    questionText:
      "39. People usually remember less than __________ of what they hear.",
    correctAnswer: "", // Placeholder
  },
  {
    id: "L80",
    ...
    audioPrompt: "Complete the sentences.",
    questionText:
      "40. Be __________ about yourself; you don't become a perfect speaker overnight.",
    correctAnswer: "", // Placeholder
  },
];
